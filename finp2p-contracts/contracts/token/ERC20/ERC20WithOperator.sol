 ...
 *
 * This implementation provide a minting and burning mechanism.
...
contract ERC20WithOperator is Context, IERC20, IERC20Metadata, AccessControl {
    ...
    function grantMinterTo(address account) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC20WithOperator: must have admin role to grant minter");
        grantRole(MINTER_ROLE, account);
    }

    function grantOperatorTo(address account) public {
        require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "ERC20WithOperator: must have admin role to grant operator");
    ...
    function mint(address to, uint256 amount) public virtual {
        require(hasRole(MINTER_ROLE, _msgSender()), "ERC20WithOperator: must have minter role to mint");
        _mint(to, amount);
    }
