...
export interface TokenStandard {
     ...
     */
    mint(wallet: TokenWallet, asset: AssetRecord, to: string, amount: bigint, logger: Logger, opCtx?: OperationContext): Promise<ContractTransactionResponse>;
    /**
     * Transfer tokens from the signer's address to another address.
     */
    transfer(wallet: TokenWallet, asset: AssetRecord, to: string, amount: bigint, logger: Logger, opCtx?: OperationContext): Promise<ContractTransactionResponse>;
    /**
     * Burn tokens from a given address (operator burn).
     */
    burn(wallet: TokenWallet, asset: AssetRecord, from: string, amount: bigint, logger: Logger, opCtx?: OperationContext): Promise<ContractTransactionResponse>;
    /**
     ...
     */
    hold(sourceWallet: TokenWallet, escrowWallet: TokenWallet, asset: AssetRecord, amount: bigint, logger: Logger, opCtx?: OperationContext): Promise<ContractTransactionResponse>;
    /**
     ...
     */
    release(escrowWallet: TokenWallet, asset: AssetRecord, to: string, amount: bigint, logger: Logger, opCtx?: OperationContext): Promise<ContractTransactionResponse>;
}
